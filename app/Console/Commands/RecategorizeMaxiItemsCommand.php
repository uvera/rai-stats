...
class RecategorizeMaxiItemsCommand extends Command
{
    protected $signature = 'maxi:recategorize-items {--dry-run} {--force}';

    protected $description = 'Re-applies product category rules to every Moj Maxi receipt item (run after editing rules)';
    ...
    public function handle(): int
    {
        ...
        MaxiReceiptItem::query()->orderBy('id')->chunkById(500, function ($items) use ($categorizer, $force, $dryRun, &$updated, &$skippedManual) {
