...
namespace App\Filament\Resources\MaxiReceipts\RelationManagers;
        ...
        return $table
            ...
            ->recordActions([
                Action::make('categorize')
                    ...
                    ->fillForm(fn (MaxiReceiptItem $record) => ['product_category_id' => $record->product_category_id])
                    ->action(function (MaxiReceiptItem $record, array $data): void {
                        $record->update([
